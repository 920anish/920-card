  ...
  return (
    <main className="flex flex-col items-center justify-center"> 
      <div className="flex flex-col gap-2 items-center justify-center h-screen">
        <div className="flex flex-col gap-2 items-center px-16 py-6 sm:py-10 rounded-lg shadow-lg hover:shadow-2xl dark:hover:shadow-slate-800 transition-shadow duration-500 ease-in-out cursor-pointer bg-slate-100 dark:bg-zinc-900">
